...
class Unet(nn.Module):
    def __init__(self, filters=[64, 128, 256, 512,1024],out_size=1):
        super().__init__()
        ...
        self.conv1 = nn.Sequential(unetConv2(1, filters[0]),unetConv2(filters[0], filters[0]),unetConv2(filters[0], filters[0]))

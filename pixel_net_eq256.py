...
class PixelNet(nn.Module):
    def __init__(self,K=24,input_size=3,gconv=0,p4m=0,return_features=0):
        super().__init__()
        ...
        self.c_add=Conv2BnRelu(K, K,gconv=gconv,p4m=1)
        ...
        self.c4_1=Conv2BnRelu(K, K,gconv=gconv,p4m=1)
